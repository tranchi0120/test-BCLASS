...
import { acreageOptions, PriceOptions } from '@/exampleTest/data/defaultData.js'

const FormInput = () => {
    const { listCity, listDistrict, listData, setFilteredData } =
    ...
    const handleSearch = (e) => {
        ...
        if (selectedPrice) {
            listDataAfterSearch = filterByPrice(
                listDataAfterSearch,
                selectedPrice
            )
        }
